...
Version  : 2.7.0
Release  : 4
URL      : https://github.com/KDE/kdiagram/archive/v2.7.0/kdiagram-2.7.0.tar.gz
Source0  : https://github.com/KDE/kdiagram/archive/v2.7.0/kdiagram-2.7.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589235278
mkdir -p clr-build
pushd clr-build
